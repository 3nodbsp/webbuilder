...
public class DiscussqichexinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussqichexinxiEntity discussqichexinxi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussqichexinxiEntity discussqichexinxi, HttpServletRequest request){
        EntityWrapper<DiscussqichexinxiEntity> ew = new EntityWrapper<DiscussqichexinxiEntity>();
		PageUtils page = discussqichexinxiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussqichexinxi), params), params));
        return R.ok().put("data", page);
    }
