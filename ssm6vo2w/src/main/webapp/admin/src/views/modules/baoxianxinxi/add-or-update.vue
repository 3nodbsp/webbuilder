<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="保险单号" prop="baoxiandanhao">
            <el-input v-model="ruleForm.baoxiandanhao" 
                placeholder="保险单号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baoxiandanhao" label="保险单号" prop="baoxiandanhao">
              <el-input v-model="ruleForm.baoxiandanhao" 
                placeholder="保险单号" readonly></el-input>
          </el-form-item>
        </div>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="汽车编号" prop="qichebianhao">
          <el-input v-model="ruleForm.qichebianhao" 
              placeholder="汽车编号" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="汽车编号" prop="qichebianhao">
              <el-input v-model="ruleForm.qichebianhao" 
        ...
        <el-form-item class="input" v-if="type!='info'"  label="保险费用" prop="baoxianfeiyong">
          <el-input v-model="ruleForm.baoxianfeiyong" 
              placeholder="保险费用" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="保险费用" prop="baoxianfeiyong">
              <el-input v-model="ruleForm.baoxianfeiyong" 
                placeholder="保险费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="生效时间" prop="shengxiaoshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.shengxiaoshijian" 
                type="date"
                placeholder="生效时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shengxiaoshijian" label="生效时间" prop="shengxiaoshijian">
              <el-input v-model="ruleForm.shengxiaoshijian" 
                placeholder="生效时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="截至时间" prop="jiezhishijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiezhishijian" label="截至时间" prop="jiezhishijian">
              <el-input v-model="ruleForm.jiezhishijian" 
                placeholder="截至时间" readonly></el-input>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="保险内容" prop="baoxianneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.baoxianneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.baoxianneirong" label="保险内容" prop="baoxianneirong">
                    <span v-html="ruleForm.baoxianneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
                    if(o=='baoxiandanhao'){
            this.ruleForm.baoxiandanhao = obj[o];
            continue;
          }
                    if(o=='qichebianhao'){
            ...
            continue;
                    ...
                    if(o=='baoxianneirong'){
            this.ruleForm.baoxianneirong = obj[o];
            continue;
          }
                    if(o=='shengxiaoshijian'){
            this.ruleForm.shengxiaoshijian = obj[o];
            continue;
          }
                    if(o=='jiezhishijian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `baoxianxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.baoxianxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
