          ...
          <el-form-item class="input" label="用户姓名" prop="yonghuxingming">
              <el-input v-model="ruleForm.yonghuxingming" 
                placeholder="用户姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="违章地点" prop="weizhangdidian">
          <el-input v-model="ruleForm.weizhangdidian" 
              placeholder="违章地点" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="违章地点" prop="weizhangdidian">
              <el-input v-model="ruleForm.weizhangdidian" 
                placeholder="违章地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                        </el-row>
                                                                                                                                                                                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="处理结果" prop="chulijieguo">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.chulijieguo" label="处理结果" prop="chulijieguo">
                    <span v-html="ruleForm.chulijieguo"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='weizhangdidian'){
            this.ruleForm.weizhangdidian = obj[o];
            continue;
          }
                    if(o=='chulijieguo'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `weizhangjilu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.weizhangjiluCrossAddOrUpdateFlag = false;
                  this.parent.search();
