          ...
          <el-form-item class="input" label="租金" prop="zujin">
              <el-input v-model="ruleForm.zujin" 
                placeholder="租金" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="续租天数" prop="xuzutianshu">
          <el-input v-model="ruleForm.xuzutianshu" 
              placeholder="续租天数" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="续租天数" prop="xuzutianshu">
              <el-input v-model="ruleForm.xuzutianshu" 
                placeholder="续租天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  computed: {
                                                                                    zongjine:{
                                                                                                                                                                                                                  get: function () {
        return 1*this.ruleForm.zujin*this.ruleForm.xuzutianshu
      }
    },
                                                                                      },
  created() {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='xuzutianshu'){
            this.ruleForm.xuzutianshu = obj[o];
            continue;
          }
                    if(o=='zongjine'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xuzuxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xuzuxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
