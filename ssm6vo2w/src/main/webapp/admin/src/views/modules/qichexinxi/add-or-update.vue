          ...
          <el-form-item class="input" label="租金" prop="zujin">
              <el-input v-model="ruleForm.zujin" 
                placeholder="租金" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="取车地点" prop="quchedidian">
          <el-input v-model="ruleForm.quchedidian" 
              placeholder="取车地点" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="取车地点" prop="quchedidian">
              <el-input v-model="ruleForm.quchedidian" 
                placeholder="取车地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="还车地点" prop="haichedidian">
          <el-input v-model="ruleForm.haichedidian" 
              placeholder="还车地点" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="还车地点" prop="haichedidian">
              <el-input v-model="ruleForm.haichedidian" 
                placeholder="还车地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="车辆消毒时间" prop="cheliangxiaodushijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.cheliangxiaodushijian" 
                type="datetime"
                placeholder="车辆消毒时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.cheliangxiaodushijian" label="车辆消毒时间" prop="cheliangxiaodushijian">
              <el-input v-model="ruleForm.cheliangxiaodushijian" 
                placeholder="车辆消毒时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                        </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='quchedidian'){
            this.ruleForm.quchedidian = obj[o];
            continue;
          }
                    if(o=='haichedidian'){
            this.ruleForm.haichedidian = obj[o];
            continue;
          }
                    if(o=='cheliangxiaodushijian'){
            this.ruleForm.cheliangxiaodushijian = obj[o];
            continue;
          }
                    if(o=='xiangqing'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                                      ...
                                                                                                                                                      this.zhuangtaiOptions = "待租,已租".split(',')
