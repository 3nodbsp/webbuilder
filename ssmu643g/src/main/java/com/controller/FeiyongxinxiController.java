...
public class FeiyongxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,FeiyongxinxiEntity feiyongxinxi, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			feiyongxinxi.setYonghuming((String)request.getSession().getAttribute("username"));
		}
