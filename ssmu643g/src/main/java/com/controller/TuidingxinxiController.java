...
public class TuidingxinxiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,TuidingxinxiEntity tuidingxinxi, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yonghu")) {
			tuidingxinxi.setYonghuming((String)request.getSession().getAttribute("username"));
		}
