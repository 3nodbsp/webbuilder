          ...
          <el-form-item class="input" label="客房类型" prop="kefangleixing">
              <el-input v-model="ruleForm.kefangleixing" 
                placeholder="客房类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="续住天数" prop="xuzutianshu">
          <el-input v-model="ruleForm.xuzutianshu" 
              placeholder="续住天数" clearable ></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="续住天数" prop="xuzutianshu">
              <el-input v-model="ruleForm.xuzutianshu" 
                placeholder="续住天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
