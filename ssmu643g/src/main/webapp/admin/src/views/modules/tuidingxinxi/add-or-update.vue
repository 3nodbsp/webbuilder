          ...
          <el-form-item class="input" v-if="ruleForm.dengjishijian" label="登记时间" prop="dengjishijian">
              <el-input v-model="ruleForm.dengjishijian" 
                placeholder="登记时间" readonly></el-input>
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="退订原因" prop="tuidingyuanyin">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tuidingyuanyin" label="退订原因" prop="tuidingyuanyin">
                    <span v-html="ruleForm.tuidingyuanyin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
