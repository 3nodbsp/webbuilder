          ...
          <el-form-item class="input" v-if="ruleForm.dengjishijian" label="登记时间" prop="dengjishijian">
              <el-input v-model="ruleForm.dengjishijian" 
                placeholder="登记时间" readonly></el-input>
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="换房原因" prop="huanfangyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="换房原因"
                  v-model="ruleForm.huanfangyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.huanfangyuanyin" label="换房原因" prop="huanfangyuanyin">
                    <span>{{ruleForm.huanfangyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='huanfangyuanyin'){
            this.ruleForm.huanfangyuanyin = obj[o];
            continue;
          }
                    if(o=='yonghuming'){
